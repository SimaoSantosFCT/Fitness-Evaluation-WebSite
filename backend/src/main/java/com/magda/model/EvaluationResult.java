...
public class EvaluationResult {
    ...
    private double calculatedWaterPercent;
    private double calculatedIdealWeight;
    private double calculatedIdealWeightMin;
    private double calculatedIdealWeightMax;
    private double calculatedMetabolicAge;
    private String visceralRiskLabel;
    private double whtr;
    private String activityLevelLabel;
    private String bodyFrameLabel;
    private String waterZone;       // "baixo" | "saudavel" | "alto" | "muito_alto"
    private String fatMassZone;     // "baixo" | "bom" | "normal" | "elevado"
    private String muscleMassZone;  // "baixo" | "saudavel" | "bom" | "excelente"
    ...
    public void setCalculatedTDEE(double v)               { this.calculatedTDEE = v; }
    public double getCalculatedWaterPercent()             { return calculatedWaterPercent; }
    public void setCalculatedWaterPercent(double v)       { this.calculatedWaterPercent = v; }
    public double getCalculatedIdealWeight()              { return calculatedIdealWeight; }
    public void setCalculatedIdealWeight(double v)        { this.calculatedIdealWeight = v; }
    public double getCalculatedIdealWeightMin()           { return calculatedIdealWeightMin; }
    public void setCalculatedIdealWeightMin(double v)     { this.calculatedIdealWeightMin = v; }
    public double getCalculatedIdealWeightMax()           { return calculatedIdealWeightMax; }
    public void setCalculatedIdealWeightMax(double v)     { this.calculatedIdealWeightMax = v; }
    public double getCalculatedMetabolicAge()             { return calculatedMetabolicAge; }
    public void setCalculatedMetabolicAge(double v)       { this.calculatedMetabolicAge = v; }
    ...
    public String getActivityLevelLabel()                 { return activityLevelLabel; }
    public void setActivityLevelLabel(String v)           { this.activityLevelLabel = v; }
    public String getBodyFrameLabel()                     { return bodyFrameLabel; }
    public void setBodyFrameLabel(String v)               { this.bodyFrameLabel = v; }
    public String getWaterZone()                          { return waterZone; }
    public void setWaterZone(String v)                    { this.waterZone = v; }
    public String getFatMassZone()                        { return fatMassZone; }
    public void setFatMassZone(String v)                  { this.fatMassZone = v; }
    public String getMuscleMassZone()                     { return muscleMassZone; }
    public void setMuscleMassZone(String v)               { this.muscleMassZone = v; }
}